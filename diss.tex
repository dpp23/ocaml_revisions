...
Here I am using the build-in in Core functor {\tt Set.Make} to create a integer set. The functor expect a module with a signature that covers the type of the set elements, i.e {\tt t}, and the comparison function. Notice the use of the build-in function from the module {\tt Int} on line 4.
